...
export default function App() {
  ...
  return (
    <div className="w-full text-center">
      ...
      <button onClick={() => chrome.runtime?.sendMessage?.({ action: "stopScroll" })} id="twitter-agent-btn-stop" className="fixed right-5 z-[9999] p-2.5 text-white border-none rounded-md cursor-pointer shadow-md bg-[#e11d48]">Stop</button> */}
  
      <CommentChat
        // otherData={otherData}
        // key={`${aiContent}|${aiReply}`}   // forces remount on new analysis
        // initialSuggestion={aiReply}
        // tweetContent={aiContent}
